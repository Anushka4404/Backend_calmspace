...
function generateReportEmailContent(report) {
  ...
  return `
    ...
    <head>
      ...
      <title>CalmSpace Mental Health Report</title>
      <style>
        * {
          margin: 0;
          padding: 0;
      ...
      <div class="email-container">
        <div class="header">
          <h1>
            ...
            CalmSpace Mental Health Report
          </h1>
        ...
        <div class="footer">
          <div class="footer-content">
            <div class="disclaimer">
              <strong>⚠️ Important Disclaimer:</strong> This report is generated by CalmSpace AI system and is for informational purposes only. It should not be considered as a substitute for professional medical advice, diagnosis, or treatment. Please consult with a qualified healthcare professional for proper evaluation and treatment.
            </div>
            
            <div class="contact-info">
              <p><strong>Need Support?</strong></p>
              <p>📧 Email: support@calmspace.edu</p>
              <p>📞 Helpline: 9152987821 (24/7)</p>
              <p>🚨 Emergency: 112</p>
            </div>
            
            <p style="color: #64748b; font-size: 12px; margin-top: 20px;">
              © ${new Date().getFullYear()} CalmSpace. All rights reserved.<br>
